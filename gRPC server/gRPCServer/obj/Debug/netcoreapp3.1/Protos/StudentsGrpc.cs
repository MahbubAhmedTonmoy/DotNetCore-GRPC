...
namespace gRPCServer.Protos {
  public static partial class Student
  {
    ...
    static readonly grpc::Marshaller<global::gRPCServer.Protos.GetStudentByIdModel> __Marshaller_GetStudentByIdModel = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::gRPCServer.Protos.GetStudentByIdModel.Parser));
    static readonly grpc::Marshaller<global::gRPCServer.Protos.StudentModel> __Marshaller_StudentModel = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::gRPCServer.Protos.StudentModel.Parser));
    static readonly grpc::Marshaller<global::gRPCServer.Protos.GetAllStudentsRequest> __Marshaller_GetAllStudentsRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::gRPCServer.Protos.GetAllStudentsRequest.Parser));
